...
public class DistributedCacheTest {
    ...
    public void setUp() throws Exception {
        ...
        ElasticsearchIndexStoreManager indexStoreManager = Mockito.mock(ElasticsearchIndexStoreManager.class);
        AnalyticsLoader analyticsLoader = new AnalyticsLoader(tableMetadataManager, queryStore, indexStoreManager, null);
